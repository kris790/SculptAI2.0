...
export const TrophyIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 01-4.874-1.944l-1.026-1.026a.75.75 0 01.53-1.28h1.844a.75.75 0 00.53-.22l1.026-1.026a9.75 9.75 0 0113.788 0l1.026 1.026a.75.75 0 00.53.22h1.844a.75.75 0 01.53 1.28l-1.026 1.026A9.75 9.75 0 0116.5 18.75zM12 12.75a.75.75 0 00-1.5 0v2.25a.75.75 0 001.5 0v-2.25zM12 6a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75h-.008A.75.75 0 0112 6z" />
    </svg>
);
...
export const UserGroupIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.952a4.5 4.5 0 011.088 2.254l1.205 5.063a.75.75 0 01-1.28.53l-1.405-1.405a.75.75 0 01.53-1.28H18a3.75 3.75 0 013.75 3.75v.75a3.75 3.75 0 01-3.75 3.75h-9.344a.75.75 0 01-.53-1.28l1.405-1.405a.75.75 0 011.28.53l-1.205 5.063a4.5 4.5 0 01-1.088 2.254M12 12.75a4.5 4.5 0 100-9 4.5 4.5 0 000 9z" />
    </svg>
);
